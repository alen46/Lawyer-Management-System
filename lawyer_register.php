		...
		<section class="registerform">
			<div class="container">
				<div class="row">
					<div class="col-md-6">
						<center>
						<h2>Register Here </i></h2></center>
						<img src="images/lreg.png" alt="" class="img-fluid">
					</div>
					<div class="col-md-6">
						<form  action="lawyer_registation.php"  method="post" enctype="multipart/form-data"  id="validateForm">
							...
							<div class="form-group">
									...
									<input type="text" class="form-control" id="enrollment" name="enrollment" placeholder="Enrollment Number">
								</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label for="practise">Speciality</label>
				...
				fields: {
					...
					enrollment: {
						validators: {
							stringLength: {
								min: 13,
								message: 'Please Enter your valid Enrollment Number',
							},
							notEmpty: {
					...
					about: {
						validators: {
							notEmpty: {
								message: 'Please say something about you'
							}
						}
					},
					city: {
