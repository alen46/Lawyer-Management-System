					...
					<div class="row " >
						...
						<?php
							...
							if (isset($_POST['submit'])){
								...
								$result = mysqli_query($conn,"SELECT * FROM user, lawyer WHERE user.u_id = lawyer.lawyer_id AND user.status = 'Active' AND user.role = 'Lawyer' AND (lawyer.experience = '$experience' OR lawyer.speciality = '$speciality' OR lawyer.city = '$location');");
